...
class File(tkinter.Frame):
    def __init__(self, root, height=650, width=650):
        super().__init__(root)
        self.root = root
    ...
    def create_widgets(self):
        ...
        self.settings_frame = tkinter.LabelFrame(self,
                                                 text="Ajustes de la rueda")
        ...
        # background
        # ==========
        self.background_var = tkinter.StringVar(self, "#888888")
    ...
    def distribute_widgets(self):
        ...
        # data treeview
        # =============
        self.color_treeview.grid(row=0, column=0)
        self.hexrgb_treeview.grid(row=0, column=1)
        self.hexrgba_treeview.grid(row=0, column=2)

        self.r_treeview.grid(row=0, column=3)
        self.g_treeview.grid(row=0, column=4)
        self.b_treeview.grid(row=0, column=5)
    ...
    def draw_wheel(self, event=None):
        ...
        for i, (hex_val, R, G, B) in enumerate(colors):
            ...
            self.color_treeview.insert('', 'end', values=[""], tags=(hex_val,))
        ...
        self.canvas.create_oval(70, 70, self.width - 70, self.height - 70,
    ...
    def set_events(self):
        ...
        self.color_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.color_treeview))
        self.hexrgb_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.hexrgb_treeview))
        self.hexrgba_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.hexrgba_treeview))
        self.r_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.r_treeview))
        self.g_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.g_treeview))
        self.b_treeview.bind(
            "<Double-Button-1>",
            self.copy_data(self.b_treeview))


if __name__ == '__main__':
    File(tkinter.Tk()).root.mainloop()
